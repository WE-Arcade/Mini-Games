  ...
  function dragDrop() {
    ...
    if (isHorizontal && !newNotAllowedHorizontal.includes(shipLastId)) {
      for (let i = 0; i < draggedShipLength; i++) {
        ...
        userSquares[parseInt(this.dataset.id) - selectedShipIndex + i].style.backgroundImage = draggedShip.style.backgroundImage;
      }
      ...
      for (let i = 0; i < draggedShipLength; i++) {
        ...
        userSquares[parseInt(this.dataset.id) - selectedShipIndex + width * i].style.backgroundImage = draggedShip.style.backgroundImage;
      }
    } else return;
